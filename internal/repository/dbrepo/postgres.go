...
// SearchAvailabilityByDatesByRoomID return true if room available for roomID, false if not available
...
// SearchAvailabilityForAllRoom returns a slice of a available rooms, if any, for given range
...
// DeleteReservation remove a reservation from database
...
// UpdateProcessedForReservation changes reservation status by id
